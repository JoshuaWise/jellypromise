...
Promise.prototype.finally = function (fn) {
	...
	return this._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(value) {
		return Promise.resolve(fn())._85(function () {
			return value
		})
...
Promise.prototype.tap = function (fn) {
	...
	return this._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(value) {
		return Promise.resolve(fn(value))._85(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._85(null, function () {return value})
}
Promise.prototype.delay = function (ms) {
	return this._85(function (value) {
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._84(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._85(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._84(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._85(resolveItem(key), rej)
		}
	})
}
Promise.settle = function (iterable) {
	return new Promise(INTERNAL)._84(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			...
			promise._85(handler, handler)
		}
	})
}
Promise.iterate = function (iterable, fn) {
	var promise = new Promise(INTERNAL)
	return promise._84(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next__c9d565ea_0267_11e6_8d22_5e5517507c66() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._85(fn)._85(next__c9d565ea_0267_11e6_8d22_5e5517507c66)
				p._40.parent = promise._40 // @[/development]
				p._85(null, rej)
			}
		}())
	})
...
var PromiseDescriptor = function Promise(promise) {
	...
	if (promise._24 & 1) {
		...
		this.value = promise._1
	} else if (promise._24 & 2) {
		this.state = 'rejected'
		this.reason = promise._1
	} else {
		this.state = 'pending'
	}
}
