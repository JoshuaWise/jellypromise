...
function _56(trim) {
	...
	this._87 = new _88(stackPoint, this._87, trim, null)
	if (context.stack) {
		var end = this._87
...
function _71(err) {
	if (err instanceof Error
			...
			&& this._87.error !== err) {
		this._87 = new _88(stackPointFromError(err), this._87, 0, err)
		cleanStackTrace(this._87)
	}
}

function _88(stackPoint, parent, trim, error) {
...
_88.prototype.getTrace = function () {
	var point = this
	var stacks = []
