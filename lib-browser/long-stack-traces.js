...
function _45(trim) {
	var stackPoint = captureStackPoint(_45)
	this._71 = new _29(stackPoint, this._71, trim, null)
	if (context.stack) {
		var end = this._71
...
function _32(err) {
	if (err instanceof Error
			...
			&& this._71.error !== err) {
		this._71 = new _29(stackPointFromError(err), this._71, 0, err)
		cleanStackTrace(this._71)
	}
}

function _29(stackPoint, parent, trim, error) {
