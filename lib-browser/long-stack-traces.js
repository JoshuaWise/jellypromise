...
exports.init = function () {
	...
	Promise.prototype._5 = _5
}

// Used before an asynchronous callback.
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._32
	context.previousStack = promise._32
}
...
function _61(trim) {
	...
	this._32 = new _80(stackPoint, this._32, trim, null)
	if (context.stack) {
		var end = this._32
...
function _5(err) {
	if (err instanceof Error
		...
		this._32 = new _80(stackPoint, this._32, 0, err)
		cleanStackTrace(this._32)
	}
}
