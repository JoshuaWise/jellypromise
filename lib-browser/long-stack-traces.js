...
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._40
	context.previousStack = promise._40
}
...
function _78(trim) {
	var stackPoint = captureStackPoint(_78)
	this._40 = new _35(stackPoint, this._40, trim, null)
	if (context.stack) {
		var end = this._40
...
function _11(err) {
	if (err instanceof Error
		...
		this._40 = new _35(stackPoint, this._40, 0, err)
		cleanStackTrace(this._40)
	}
}
