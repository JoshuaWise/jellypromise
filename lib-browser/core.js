...
function finale(self) {
	if (self._12 === 1) {
		handle(self, self._37)
		self._37 = null
	} else if (self._12 === 2) {
		var deferreds = self._37
...
function handle(self, deferred) {
	...
	if (self._63 === 0) {
		if (self._12 === 0) {
			...
			self._12 = 2
			self._37 = [self._37, deferred]
		} else {
			self._37.push(deferred)
		}
	} else {
...
function handleResolved(self, deferred) {
	asap(function () {
		var cb = self._63 === 1 ? deferred.onFulfilled : deferred.onRejected
		if (cb === null) {
			if (self._63 === 1) {
				resolve(deferred.promise, self._84)
			} else {
				reject(deferred.promise, self._84)
			}
		} else {
			var ret = tryCallOne(cb, self._84)
			if (ret === IS_ERROR) {
