...
Promise.prototype.filter = function (fn, ctx) {
	return this._44(function (iterable) {
		...
		return Promise.all(iterable)._44(function (array) {
			...
			return Promise.all(bools)._44(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._44(function (iterable) {
		...
		return Promise.all(iterable)._44(function (array) {
			...
			return Promise.all(mapped)._44(function () {return array})
		})
	})
}
	...
	return this._44(function (iterable) {
		...
		return new Promise(INTERNAL)._56(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._44(setResult)
			}
			var next = function () {
				i === len
					? res(result)
