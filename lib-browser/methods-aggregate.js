...
Promise.prototype.filter = function (fn, ctx) {
	return this._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(bools)._85(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return Promise.all(iterable)._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(mapped)._85(function () {return array})
		})
	})
}
	...
	return this._85(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return new Promise(INTERNAL)._84(function (res, rej) {
			...
			var handler = function __c9d565ea_0267_11e6_8d22_5e5517507c66(item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._85(setResult)
			}
			var next = function __c9d565ea_0267_11e6_8d22_5e5517507c66() {
				i === len
					? res(result)
					: Promise.resolve(array[i])._85(handler)._85(null, rej)
			}
			next()
		})
	})
