...
Promise.prototype.filter = function (fn, ctx) {
	return this._9(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._9(function (array) {
			...
			return Promise.all(bools)._9(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._9(function (iterable) {
		...
		return Promise.all(iterable)._9(function (array) {
			...
			return Promise.all(mapped)._9(function () {return array})
		})
	})
}
	...
	return this._9(function (iterable) {
		...
		return new Promise(INTERNAL)._95(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._9(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._9(handler)._9(null, rej)
			}
			next()
		})
	})
