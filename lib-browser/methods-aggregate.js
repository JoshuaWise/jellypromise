...
Promise.prototype.filter = function (fn, ctx) {
	return this._97(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._97(function (array) {
			...
			return Promise.all(bools)._97(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._97(function (iterable) {
		...
		return Promise.all(iterable)._97(function (array) {
			...
			return Promise.all(mapped)._97(function () {return array})
		})
	})
}
	...
	return this._97(function (iterable) {
		...
		return new Promise(INTERNAL)._70(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._97(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._97(handler)._97(null, rej)
			}
			next()
		})
	})
