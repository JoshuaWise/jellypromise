...
Promise.prototype.filter = function (fn, ctx) {
	return this._73(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		var array = asArrayCopy__c9d565ea_0267_11e6_8d22_5e5517507c66(iterable)
		return mapArray(array, fn, ctx)._73(function (bools) {
			var result = []
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._73(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		var array = asArrayCopy__c9d565ea_0267_11e6_8d22_5e5517507c66(iterable)
		return mapArray(array, fn, ctx)._73(function () {
			return array
		})
	})
}
	...
	return this._73(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return new Promise(INTERNAL)._2(function (res, rej) {
			...
			var handler = function __c9d565ea_0267_11e6_8d22_5e5517507c66(item) {
				...
				return Promise.resolve(fn(result, item, i++, len))._73(setResult)
			}
			var next = function __c9d565ea_0267_11e6_8d22_5e5517507c66() {
				i === len
					? res(result)
					: Promise.resolve(array[i])._73(handler)._73(null, rej)
			}
			next()
		})
	})
	...
	return new Promise(INTERNAL)._2(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		...
		var each = function (i) {
			return function __c9d565ea_0267_11e6_8d22_5e5517507c66(value) {
				return Promise.resolve(fn.call(ctx, value, i, len))._73(function (value) {
					result[i] = value
		...
		for (var i=0, len=pendings; i<len; i++) {
			Promise.resolve(input[i])._73(each(i))._73(null, rej)
		}
	})
}
