...
To solve these problems, we provide the class `Promise.Stream`. For detailed usage and documentation, see the [Stream API](https://github.com/JoshuaWise/jellypromise/wiki/Stream-API).
