...
To solve these problems, we provide the class `Promise.Stream`. For detailed documentation, see the [Stream API](https://github.com/JoshuaWise/jellypromise/wiki/Streaming-API).
