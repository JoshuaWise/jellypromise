...
function _79(trim) {
	var stackPoint = captureStackPoint(_79)
	this._70 = new _69(stackPoint, this._70, trim, null)
	if (context.stack) {
		var end = this._70
...
function _96(err) {
	if (err instanceof Error
			...
			&& this._70.error !== err) {
		this._70 = new _69(stackPointFromError(err), this._70, 0, err)
		cleanStackTrace(this._70)
	}
}

function _69(stackPoint, parent, trim, error) {
...
_69.prototype.getTrace = function () {
	var point = this
	var stacks = []
