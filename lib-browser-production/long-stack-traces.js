...
exports.init = function () {
	...
	Promise.prototype._34 = _34
}

// Used before an asynchronous callback.
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._66
	context.previousStack = promise._66
}
...
function _58(trim) {
	...
	this._66 = new _0(stackPoint, this._66, trim, null)
	if (context.stack) {
		var end = this._66
...
function _34(err) {
	if (err instanceof Error
			...
			&& this._66.error !== err) {
		this._66 = new _0(stackPointFromError(err), this._66, 0, err)
		cleanStackTrace(this._66)
	}
}

function _0(stackPoint, parent, trim, error) {
...
_0.prototype.getTrace = function () {
	var point = this
	var stacks = []
