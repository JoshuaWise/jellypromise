...
function _21(trim) {
	var stackPoint = captureStackPoint(_21)
	this._30 = new _48(stackPoint, this._30, trim, null)
	if (context.stack) {
		var end = this._30
...
function _11(err) {
	if (err instanceof Error
		...
		this._30 = new _48(stackPoint, this._30, 0, err)
		cleanStackTrace(this._30)
	}
}

function _48(stackPoint, parent, trim, err) {
...
_48.prototype.getTrace = function () {
	var point = this
	var stacks = []
	do {
