...
function _52(trim) {
	var stackPoint = captureStackPoint(_52)
	this._75 = new _61(stackPoint, this._75, trim, null)
	if (context.stack) {
		var end = this._75
...
function _24(err) {
	if (err instanceof Error
			...
			&& this._75.error !== err) {
		this._75 = new _61(stackPointFromError(err), this._75, 0, err)
		cleanStackTrace(this._75)
	}
}

function _61(stackPoint, parent, trim, error) {
...
_61.prototype.getTrace = function () {
	var point = this
	var stacks = []
