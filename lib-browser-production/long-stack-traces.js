...
exports.init = function () {
	...
	Promise.prototype._39 = _39
}

// Used before an asynchronous callback.
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._42
	context.previousStack = promise._42
}
...
function _5(trim) {
	var stackPoint = captureStackPoint(_5)
	this._42 = new _62(stackPoint, this._42, trim, null)
	if (context.stack) {
		var end = this._42
...
function _39(err) {
	if (err instanceof Error
		...
		this._42 = new _62(stackPoint, this._42, 0, err)
		cleanStackTrace(this._42)
	}
}

function _62(stackPoint, parent, trim, err) {
