...
function _1(trim) {
	...
	this._96 = new _81(stackPoint, this._96, trim, null)
	if (context.stack) {
		var end = this._96
...
function _38(err) {
	if (err instanceof Error
			...
			&& this._96.error !== err) {
		this._96 = new _81(stackPointFromError(err), this._96, 0, err)
		cleanStackTrace(this._96)
	}
}

function _81(stackPoint, parent, trim, error) {
...
_81.prototype.getTrace = function () {
	var point = this
	var stacks = []
