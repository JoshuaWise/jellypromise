...
Promise.prototype.filter = function (fn, ctx) {
	return this._56(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._56(function (array) {
			...
			return Promise.all(bools)._56(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._56(function (iterable) {
		...
		return Promise.all(iterable)._56(function (array) {
			...
			return Promise.all(mapped)._56(function () {return array})
		})
	})
}
	...
	return this._56(function (iterable) {
		...
		return new Promise(INTERNAL)._40(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._56(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._56(handler)._56(null, rej)
			}
			next()
		})
	})
