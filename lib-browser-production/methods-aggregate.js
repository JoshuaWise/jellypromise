...
Promise.prototype.filter = function (fn, ctx) {
	return this._59(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._59(function (array) {
			...
			return Promise.all(bools)._59(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._59(function (iterable) {
		...
		return Promise.all(iterable)._59(function (array) {
			...
			return Promise.all(mapped)._59(function () {return array})
		})
	})
}
	...
	return this._59(function (iterable) {
		...
		return new Promise(INTERNAL)._79(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._59(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._59(handler)._59(null, rej)
			}
			next()
		})
	})
