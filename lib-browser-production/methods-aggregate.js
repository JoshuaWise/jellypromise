...
Promise.prototype.filter = function (fn, ctx) {
	return this._48(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._48(function (array) {
			...
			return Promise.all(bools)._48(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._48(function (iterable) {
		...
		return Promise.all(iterable)._48(function (array) {
			...
			return Promise.all(mapped)._48(function () {return array})
		})
	})
}
	...
	return this._48(function (iterable) {
		...
		return new Promise(INTERNAL)._4(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._48(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._48(handler)._48(null, rej)
			}
			next()
		})
	})
