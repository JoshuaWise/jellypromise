...
Promise.prototype.filter = function (fn, ctx) {
	return this._61(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._61(function (array) {
			...
			return Promise.all(bools)._61(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._61(function (iterable) {
		...
		return Promise.all(iterable)._61(function (array) {
			...
			return Promise.all(mapped)._61(function () {return array})
		})
	})
}
	...
	return this._61(function (iterable) {
		...
		return new Promise(INTERNAL)._2(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._61(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._61(handler)._61(null, rej)
			}
			next()
		})
	})
