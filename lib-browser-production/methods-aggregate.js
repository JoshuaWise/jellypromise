...
Promise.prototype.filter = function (fn, ctx) {
	return this._91(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._91(function (array) {
			...
			return Promise.all(bools)._91(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._91(function (iterable) {
		...
		return Promise.all(iterable)._91(function (array) {
			...
			return Promise.all(mapped)._91(function () {return array})
		})
	})
}
	...
	return this._91(function (iterable) {
		...
		return new Promise(INTERNAL)._46(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._91(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._91(handler)._91(null, rej)
			}
			next()
		})
	})
