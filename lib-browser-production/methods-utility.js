...
Promise.prototype.finally = function (fn) {
	...
	return this._56(function (value) {
		return Promise.resolve(fn())._56(function () {
			return value
		})
	}, function (reason) {
		return Promise.resolve(fn())._56(function () {
...
Promise.prototype.tap = function (fn) {
	...
	return this._56(function (value) {
		return Promise.resolve(fn(value))._56(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._56(null, function () {return value})
}
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._40(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._56(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._40(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._56(resolveItem(key), rej)
		}
	})
}
Promise.settle = function (iterable) {
	return new Promise(INTERNAL)._40(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			...
			promise._56(handler, handler)
		}
	})
}
Promise.iterate = function (iterable, fn) {
	var promise = new Promise(INTERNAL)
	return promise._40(function (res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._56(fn)._56(next)
				p._56(null, rej)
			}
		}())
	})
