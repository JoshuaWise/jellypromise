...
Promise.prototype.finally = function (fn) {
	...
	return this._61(function (value) {
		return Promise.resolve(fn())._61(function () {
			return value
		})
	}, function (reason) {
		return Promise.resolve(fn())._61(function () {
...
Promise.prototype.tap = function (fn) {
	...
	return this._61(function (value) {
		return Promise.resolve(fn(value))._61(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._61(null, function () {return value})
}
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._2(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._61(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._2(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._61(resolveItem(key), rej)
		}
	})
}
	...
	return promise._2(function (res, rej) {
		...
		;(function next() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._61(fn)._61(next)
				p._61(null, rej)
			}
		}())
	})
...
var PromiseDescriptor = function Promise(promise) {
	...
	if (promise._81 & 1) {
		...
		this.value = promise._24
	} else if (promise._81 & 2) {
		this.state = 'rejected'
		this.reason = promise._24
	} else {
		this.state = 'pending'
	}
}
