...
Promise.prototype.finally = function (fn) {
	...
	return this._59(function (value) {
		return Promise.resolve(fn())._59(function () {
			return value
		})
	}, function (reason) {
		return Promise.resolve(fn())._59(function () {
...
Promise.prototype.tap = function (fn) {
	...
	return this._59(function (value) {
		return Promise.resolve(fn(value))._59(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._59(null, function () {return value})
}
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._79(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._59(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._79(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._59(resolveItem(key), rej)
		}
	})
}
Promise.settle = function (iterable) {
	return new Promise(INTERNAL)._79(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			...
			promise._59(handler, handler)
		}
	})
}
Promise.iterate = function (iterable, fn) {
	var promise = new Promise(INTERNAL)
	return promise._79(function (res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._59(fn)._59(next)
				p._59(null, rej)
			}
		}())
	})
...
var PromiseDescriptor = function Promise(promise) {
	...
	if (promise._18 & 1) {
		...
		this.value = promise._82
	} else if (promise._18 & 2) {
		this.state = 'rejected'
		this.reason = promise._82
	} else {
		this.state = 'pending'
	}
}
