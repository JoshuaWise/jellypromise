...
Promise.promisify = function (fn, options) {
	...
	return new Function(['Promise', 'fn', 'INTERNAL', 'tryApply', 'tryCatch', 'resolve', 'reject'], body)(Promise, fn, INTERNAL, tryApply, tryCatch, Promise.prototype._3, Promise.prototype._31) // @[/production]
}
