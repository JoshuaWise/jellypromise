...
Promise.promisify = function (fn, options) {
	...
	return new Function(['Promise', 'fn', 'INTERNAL', 'tryApply', 'tryCatch', 'resolve', 'reject'], body)(Promise, fn, INTERNAL, tryApply, tryCatch, Promise.prototype._69, Promise.prototype._57) // @[/production]
}
