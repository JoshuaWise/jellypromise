...
function _83(trim) {
	var stackPoint = captureStackPoint(_83)
	this._49 = new _37(stackPoint, this._49, trim, null)
	if (context.stack) {
		var end = this._49
...
function _97(err) {
	if (err instanceof Error
			...
			&& this._49.error !== err) {
		this._49 = new _37(stackPointFromError(err), this._49, 0, err)
		cleanStackTrace(this._49)
	}
}

function _37(stackPoint, parent, trim, error) {
...
_37.prototype.getTrace = function () {
	var point = this
	var stacks = []
