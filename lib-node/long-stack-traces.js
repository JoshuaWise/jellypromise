...
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._20
	context.previousStack = promise._20
}
...
function _91(trim) {
	...
	this._20 = new _95(stackPoint, this._20, trim, null)
	if (context.stack) {
		var end = this._20
...
function _1(err) {
	if (err instanceof Error
			...
			&& this._20.error !== err) {
		this._20 = new _95(stackPointFromError(err), this._20, 0, err)
		cleanStackTrace(this._20)
	}
}

function _95(stackPoint, parent, trim, error) {
...
_95.prototype.getTrace = function () {
	var point = this
	var stacks = []
