...
function _3(trim) {
	var stackPoint = captureStackPoint(_3)
	this._15 = new _23(stackPoint, this._15, trim, null)
	if (context.stack) {
		var end = this._15
...
function _20(err) {
	if (err instanceof Error
			...
			&& this._15.error !== err) {
		this._15 = new _23(stackPointFromError(err), this._15, 0, err)
		cleanStackTrace(this._15)
	}
}

function _23(stackPoint, parent, trim, error) {
...
_23.prototype.getTrace = function () {
	var point = this
	var stacks = []
