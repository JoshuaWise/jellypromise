...
function _50(trim) {
	var stackPoint = captureStackPoint(_50)
	this._33 = new _46(stackPoint, this._33, trim, null)
	if (context.stack) {
		var end = this._33
...
function _92(err) {
	if (err instanceof Error
		...
		this._33 = new _46(stackPoint, this._33, 0, err)
		cleanStackTrace(this._33)
	}
}

function _46(stackPoint, parent, trim, err) {
...
_46.prototype.getTrace = function () {
	var point = this
	var stacks = []
	do {
