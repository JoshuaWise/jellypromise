...
exports.init = function () {
	...
	Promise.prototype._70 = _70
}

// Used before an asynchronous callback.
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._94
	context.previousStack = promise._94
}
...
function _53(trim) {
	var stackPoint = captureStackPoint(_53)
	this._94 = new _68(stackPoint, this._94, trim, null)
	if (context.stack) {
		var end = this._94
...
function _70(err) {
	if (err instanceof Error
			...
			&& this._94.error !== err) {
		this._94 = new _68(stackPointFromError(err), this._94, 0, err)
		cleanStackTrace(this._94)
	}
}

function _68(stackPoint, parent, trim, error) {
