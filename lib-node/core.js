...
function finale(self) {
	if (self._39 === 1) {
		handle(self, self._30)
		self._30 = null
	} else if (self._39 === 2) {
		var deferreds = self._30
...
function handle(self, deferred) {
	...
	if (self._41 === 0) {
		if (self._39 === 0) {
			...
			self._39 = 2
			self._30 = [self._30, deferred]
		} else {
			self._30.push(deferred)
		}
	} else {
...
function handleResolved(self, deferred) {
	asap(function () {
		...
		if (cb === null) {
			if (self._41 === 1) {
				resolve(deferred.promise, self._63)
			} else {
				reject(deferred.promise, self._63)
			}
		} else {
			var ret = tryCallOne(cb, self._63)
			if (ret === IS_ERROR) {
