...
Promise.prototype.filter = function (fn, ctx) {
	return this._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(bools)._42(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return Promise.all(iterable)._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(mapped)._42(function () {return array})
		})
	})
}
	...
	return this._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return new Promise(INTERNAL)._82(function (res, rej) {
			...
			var handler = function __c9d565ea_0267_11e6_8d22_5e5517507c66(item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._42(setResult)
			}
			var next = function __c9d565ea_0267_11e6_8d22_5e5517507c66() {
				i === len
					? res(result)
					: Promise.resolve(array[i])._42(handler)._42(null, rej)
			}
			next()
		})
	})
