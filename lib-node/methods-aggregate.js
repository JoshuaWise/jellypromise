...
Promise.prototype.filter = function (fn, ctx) {
	return this._69(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._69(function (array) {
			...
			return Promise.all(bools)._69(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._69(function (iterable) {
		...
		return Promise.all(iterable)._69(function (array) {
			...
			return Promise.all(mapped)._69(function () {return array})
		})
	})
}
	...
	return this._69(function (iterable) {
		...
		return new Promise(INTERNAL)._16(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._69(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._69(handler)._69(null, rej)
			}
			next()
		})
	})
