...
Promise.prototype.filter = function (fn, ctx) {
	return this._81(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._81(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(bools)._81(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._81(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return Promise.all(iterable)._81(function __c9d565ea_0267_11e6_8d22_5e5517507c66(array) {
			...
			return Promise.all(mapped)._81(function () {return array})
		})
	})
}
	...
	return this._81(function __c9d565ea_0267_11e6_8d22_5e5517507c66(iterable) {
		...
		return new Promise(INTERNAL)._93(function (res, rej) {
			...
			var handler = function __c9d565ea_0267_11e6_8d22_5e5517507c66(item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._81(setResult)
			}
			var next = function __c9d565ea_0267_11e6_8d22_5e5517507c66() {
				i === len
					? res(result)
					: Promise.resolve(array[i])._81(handler)._81(null, rej)
			}
			next()
		})
	})
