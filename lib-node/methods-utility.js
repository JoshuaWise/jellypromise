...
Promise.prototype.finally = function (fn) {
	...
	return this._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(value) {
		return Promise.resolve(fn())._42(function () {
			return value
		})
...
Promise.prototype.tap = function (fn) {
	...
	return this._42(function __c9d565ea_0267_11e6_8d22_5e5517507c66(value) {
		return Promise.resolve(fn(value))._42(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._42(null, function () {return value})
}
Promise.prototype.delay = function (ms) {
	return this._42(function (value) {
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._82(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._42(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._82(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._42(resolveItem(key), rej)
		}
	})
}
Promise.settle = function (iterable) {
	return new Promise(INTERNAL)._82(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			...
			promise._42(handler, handler)
		}
	})
}
Promise.iterate = function (iterable, fn) {
	var promise = new Promise(INTERNAL)
	return promise._82(function __c9d565ea_0267_11e6_8d22_5e5517507c66(res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next__c9d565ea_0267_11e6_8d22_5e5517507c66() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._42(fn)._42(next__c9d565ea_0267_11e6_8d22_5e5517507c66)
				p._33.parent = promise._33 // @[/development]
				p._42(null, rej)
			}
		}())
	})
...
var PromiseDescriptor = function Promise(promise) {
	...
	if (promise._34 & 1) {
		...
		this.value = promise._32
	} else if (promise._34 & 2) {
		this.state = 'rejected'
		this.reason = promise._32
	} else {
		this.state = 'pending'
	}
}
