...
Promise.prototype.finally = function (fn) {
	...
	return this._0(function (value) {
		return Promise.resolve(fn())._0(function () {
			return value
		})
	}, function (reason) {
		return Promise.resolve(fn())._0(function () {
...
Promise.prototype.tap = function (fn) {
	...
	return this._0(function (value) {
		return Promise.resolve(fn(value))._0(function () {
			return value
		})
	})
}
Promise.prototype.else = function (value) {
	...
	return this._0(null, function () {return value})
}
...
Promise.any = function (iterable) {
	return new Promise(INTERNAL)._32(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			Promise.resolve(input[i])._0(res, fail)
		}
	})
}
Promise.props = function (obj) {
	return new Promise(INTERNAL)._32(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			var key = keys[i]
			Promise.resolve(obj[key])._0(resolveItem(key), rej)
		}
	})
}
Promise.settle = function (iterable) {
	return new Promise(INTERNAL)._32(function (res, rej) {
		...
		for (var i=0; i<pendings; i++) {
			...
			promise._0(handler, handler)
		}
	})
}
Promise.iterate = function (iterable, fn) {
	var promise = new Promise(INTERNAL)
	return promise._32(function (res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._0(fn)._0(next)
				p._20.parent = promise._20 // @[/development]
				p._0(null, rej)
			}
		}())
	})
...
var PromiseDescriptor = function Promise(promise) {
	...
	if (promise._70 & 1) {
		...
		this.value = promise._22
	} else if (promise._70 & 2) {
		this.state = 'rejected'
		this.reason = promise._22
	} else {
		this.state = 'pending'
	}
}
