...
Promise.prototype.tap = function (fn) {
	...
	return this._49(function (value) {
		return Promise.resolve(fn(value))._49(function () {
			return value
		})
	})
}
...
Promise.prototype.timeout = function (ms, reason) {
	var self = this
	return new Promise(INTERNAL)._42(function (res, rej) {
...
Promise.iterate = function (iterable, fn) {
	...
	return promise._42(function (res, rej) {
		if (typeof fn !== 'function') {
		...
		;(function next() {
			...
			if (item.done) {
				...
				var p = Promise.resolve(item.value)._49(fn)._49(next)
				p._49(null, rej)
			}
		}())
	})
