...
Promise.prototype.filter = function (fn, ctx) {
	return this._67(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._67(function (array) {
			...
			return Promise.all(bools)._67(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._67(function (iterable) {
		...
		return Promise.all(iterable)._67(function (array) {
			...
			return Promise.all(mapped)._67(function () {return array})
		})
	})
}
	...
	return this._67(function (iterable) {
		...
		return new Promise(INTERNAL)._80(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._67(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._67(handler)._67(null, rej)
			}
			next()
		})
	})
