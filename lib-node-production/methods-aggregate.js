...
Promise.prototype.filter = function (fn, ctx) {
	return this._41(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._41(function (array) {
			...
			return Promise.all(bools)._41(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._41(function (iterable) {
		...
		return Promise.all(iterable)._41(function (array) {
			...
			return Promise.all(mapped)._41(function () {return array})
		})
	})
}
	...
	return this._41(function (iterable) {
		...
		return new Promise(INTERNAL)._64(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._41(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._41(handler)._41(null, rej)
			}
			next()
		})
	})
