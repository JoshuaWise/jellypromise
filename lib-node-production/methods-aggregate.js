...
Promise.prototype.filter = function (fn, ctx) {
	return this._65(function (iterable) {
		...
		return Promise.all(iterable)._65(function (array) {
			...
			return Promise.all(bools)._65(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._65(function (iterable) {
		...
		return Promise.all(iterable)._65(function (array) {
			...
			return Promise.all(mapped)._65(function () {return array})
		})
	})
}
	...
	return this._65(function (iterable) {
		...
		return new Promise(INTERNAL)._46(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._65(setResult)
			}
			var next = function () {
				i === len
					? res(result)
