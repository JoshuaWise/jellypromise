...
Promise.prototype.filter = function (fn, ctx) {
	return this._49(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._49(function (array) {
			...
			return Promise.all(bools)._49(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._49(function (iterable) {
		...
		return Promise.all(iterable)._49(function (array) {
			...
			return Promise.all(mapped)._49(function () {return array})
		})
	})
}
	...
	return this._49(function (iterable) {
		...
		return new Promise(INTERNAL)._42(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._49(setResult)
			}
			var next = function () {
				i === len
					? res(result)
