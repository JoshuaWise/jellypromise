...
Promise.prototype.filter = function (fn, ctx) {
	return this._40(function (iterable) {
		if (typeof fn !== 'function') {
			throw new TypeError('Expected first argument to be a function.')
		}
		return Promise.all(iterable)._40(function (array) {
			...
			return Promise.all(bools)._40(function (bools) {
...
Promise.prototype.forEach = function (fn, ctx) {
	return this._40(function (iterable) {
		...
		return Promise.all(iterable)._40(function (array) {
			...
			return Promise.all(mapped)._40(function () {return array})
		})
	})
}
	...
	return this._40(function (iterable) {
		...
		return new Promise(INTERNAL)._62(function (res, rej) {
			...
			var handler = function (item) {
				...
				return Promise.resolve(fn(result, item, displayI + i++, displayLen))._40(setResult)
			}
			var next = function () {
				i === len
					? res(result)
					: Promise.resolve(array[i])._40(handler)._40(null, rej)
			}
			next()
		})
	})
