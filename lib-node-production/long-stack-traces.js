...
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._83
	context.previousStack = promise._83
}
...
function _77(trim) {
	var stackPoint = captureStackPoint(_77)
	this._83 = new _8(stackPoint, this._83, trim, null)
	if (context.stack) {
		var end = this._83
...
function _20(err) {
	if (err instanceof Error
			...
			&& this._83.error !== err) {
		this._83 = new _8(stackPointFromError(err), this._83, 0, err)
		cleanStackTrace(this._83)
	}
}

function _8(stackPoint, parent, trim, error) {
...
_8.prototype.getTrace = function () {
	var point = this
	var stacks = []
