...
function _19(trim) {
	var stackPoint = captureStackPoint(_19)
	this._43 = new _97(stackPoint, this._43, trim, null)
	if (context.stack) {
		var end = this._43
...
function _32(err) {
	if (err instanceof Error
			...
			&& this._43.error !== err) {
		this._43 = new _97(stackPointFromError(err), this._43, 0, err)
		cleanStackTrace(this._43)
	}
}

function _97(stackPoint, parent, trim, error) {
...
_97.prototype.getTrace = function () {
	var point = this
	var stacks = []
