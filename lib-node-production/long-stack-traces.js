...
function _58(trim) {
	var stackPoint = captureStackPoint(_58)
	this._41 = new _17(stackPoint, this._41, trim, null)
	if (context.stack) {
		var end = this._41
...
function _63(err) {
	if (err instanceof Error
		...
		this._41 = new _17(stackPoint, this._41, 0, err)
		cleanStackTrace(this._41)
	}
}

function _17(stackPoint, parent, trim, err) {
...
_17.prototype.getTrace = function () {
	var point = this
	var stacks = []
	do {
