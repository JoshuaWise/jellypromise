...
function _28(trim) {
	var stackPoint = captureStackPoint(_28)
	this._87 = new _77(stackPoint, this._87, trim, null)
	if (context.stack) {
		var end = this._87
...
function _45(err) {
	if (err instanceof Error
			...
			&& this._87.error !== err) {
		this._87 = new _77(stackPointFromError(err), this._87, 0, err)
		cleanStackTrace(this._87)
	}
}

function _77(stackPoint, parent, trim, error) {
...
_77.prototype.getTrace = function () {
	var point = this
	var stacks = []
