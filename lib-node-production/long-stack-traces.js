...
exports.init = function () {
	...
	Promise.prototype._91 = _91
}

// Used before an asynchronous callback.
exports.setContext = function (promise, deferred) {
	context.stack = deferred.promise._47
	context.previousStack = promise._47
}
...
function _11(trim) {
	var stackPoint = captureStackPoint(_11)
	this._47 = new _87(stackPoint, this._47, trim, null)
	if (context.stack) {
		var end = this._47
...
function _91(err) {
	if (err instanceof Error
			...
			&& this._47.error !== err) {
		this._47 = new _87(stackPointFromError(err), this._47, 0, err)
		cleanStackTrace(this._47)
	}
}

function _87(stackPoint, parent, trim, error) {
...
_87.prototype.getTrace = function () {
	var point = this
	var stacks = []
