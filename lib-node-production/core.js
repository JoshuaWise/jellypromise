...
function finale(self) {
	if (self._61 === 1) {
		handle(self, self._18)
		self._18 = null
	} else if (self._61 === 2) {
		var deferreds = self._18
...
function handle(self, deferred) {
	...
	if (self._62 === 0) {
		if (self._61 === 0) {
			...
			self._61 = 2
			self._18 = [self._18, deferred]
		} else {
			self._18.push(deferred)
		}
	} else {
...
function handleResolved(self, deferred) {
	asap(function () {
		var cb = self._62 === 1 ? deferred.onFulfilled : deferred.onRejected
		if (cb === null) {
			if (self._62 === 1) {
				resolve(deferred.promise, self._77)
			} else {
				reject(deferred.promise, self._77)
			}
		} else {
